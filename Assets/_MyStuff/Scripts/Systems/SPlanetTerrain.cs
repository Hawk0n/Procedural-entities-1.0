...
//         {
//             var k = EntityManager.CreateEntityQuery(typeof(TTerrainManager)).GetSingletonEntity();  
//             // var k = SystemAPI.GetSingletonEntity<TTerrainManager>();
//             mdPlanetTerrain = EntityManager.GetComponentData<MDPlanetTerrain>(k);
